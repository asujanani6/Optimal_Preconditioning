...
fprintf(fid, hfmt3, '\cite{doi:10.1287/opre.2022.0592}', '\cite{gao2023scalable}', '\Cref{Subgrad V}', '\Cref{alg:GDeplustVv}', ...
    '\cite{doi:10.1287/opre.2022.0592}', '\cite{gao2023scalable}', '\Cref{Subgrad V}', '\Cref{alg:GDeplustVv}', ...
    '\cite{doi:10.1287/opre.2022.0592}/\Cref{Subgrad V}', '\cite{doi:10.1287/opre.2022.0592}/\Cref{alg:GDeplustVv}');
fprintf(fid, fmt4);
