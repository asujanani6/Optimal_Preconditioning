...
% 
%       min_{e} cond(XE' * XE)  
%       min_{d} cond(DX' * DX) (optionally) subject to: d \in some subspace
%       min_{d, e} cond(DXE' * DXE)
% 
% Paper available at 
% 1. Optimal diagonal preconditioning
%    https://pubsonline.informs.org/doi/10.1287/opre.2022.0592
% 2. Scalable optimal diagonal preconditioning
%    https://arxiv.org/abs/2312.15594
...
fprintf("To run semi-infinite programming-based approach, install \n\n");
fprintf("1. Gurobi MATLAB at https://docs.gurobi.com/projects/optimizer/en/current/reference/matlab.html\n\n");
